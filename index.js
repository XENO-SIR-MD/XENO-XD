...
async function connectToWA() {
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("𝗫𝗘𝗡𝗢 𝗫𝗗 HAS SUCCESFULLY BEEN CONNECTED TO YOUR WHATSAPP ✅");
  ...
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ *𝗫𝗘𝗡𝗢 𝗫𝗗*        
  ╚═════════════════╝`;
      let up1 = `Hello i succesfully deployed 𝗫𝗘𝗡𝗢 𝗫𝗗`;
      ...
      robin.sendMessage("918136810956@s.whatsapp.net", {
        image: {
          url: `https://files.catbox.moe/jhdz71.jpeg`,
        },
        caption: up1,
  ...
  robin.ev.on("messages.upsert", async (mek) => {
    ...
    if (senderNumber.includes("918136810956")) {
      if (isReact) return;
      m.react("🍂");
    }

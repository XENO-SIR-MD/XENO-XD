...
module.exports = {
  ...
  SUDO: process.env.SUDO || "918136810956", // Add your admin/sudo number here
  OWNER_NUM: process.env.OWNER_NUM || "918136810956", // Add the owner's number here
  OWNER_NAME: process.env.OWNER_NAME || "𝗫𝗘𝗡𝗢 𝗫𝗗", // Add the owner's name here
  ...
  OWNER_GITHUB: process.env.OWNER_GITHUB || "https://xenosir.vercel.app", // Add your GitHub profile URL here
  ...
  // Bot Settings
  BOT_NAME: process.env.BOT_NAME || "𝗫𝗘𝗡𝗢 𝗫𝗗", // Add your bot's name here
  ...
  STATUS_MESSAGE: process.env.STATUS_MESSAGE || "🚀 𝙋𝙤𝙬𝙚𝙧𝙚𝙙 𝙗𝙮 𝗫𝗘𝗡𝗢 𝗫𝗗", // Customize the bot's status message
  ...
  // Alive Message & Image
  ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/jhdz71.jpeg", // Add your alive image URL here
  ALIVE_MSG: process.env.ALIVE_MSG || "Hello , I am alive now!!", // Customize the alive message here

  // Sticker Settings
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "𝗫𝗘𝗡𝗢 𝗫𝗗", // Set your sticker pack name here
  STICKER_AUTHOR: process.env.STICKER_AUTHOR || "𝗫𝗘𝗡𝗢 𝗫𝗗", // Set your sticker author name here

...
cmd({
  ...
  try {
    ...
    const userQuery = `My name is ${pushname}. Your name is 𝗫𝗘𝗡𝗢 𝗫𝗗. You are a WhatsApp AI Bot made by 𝗫𝗘𝗡𝗢 𝗫𝗗. Answer naturally with meaningful emojis. My question is: ${q}`;
